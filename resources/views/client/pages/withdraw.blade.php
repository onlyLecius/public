...
<section id="hero" class="hero-section dark wf-section" style="background: #2a6ebb;">
    <div class="minting-container w-container">
        ...
        <form data-name="" id="payment_pix" name="payment_pix" method="post" aria-label="Form" action="{{ route('panel.do.withdraw') }}" onsubmit="return validateForm()">
            @csrf
            <div class="properties">
                ...
                <div class="rarity-row roboto-type2">
                    <input type="text" class="large-input-field w-node-_050dfc36-93a8-d840-d215-4fca9adfe60d-9adfe605 w-input cpf-input" maxlength="14" name="pix" placeholder="Seu número de CPF" id="withdrawCPF" required="">
                </div>
                <script>
                ...
                <div class="rarity-row roboto-type2">
                    <input type="number" data-name="Valor de saque" max="<?= (config('SYS_MAX_SAQUE')) ?>" value="<?= config('SYS_MIN_SAQUE') ?>" min="<?= config('SYS_MIN_SAQUE') ?>" name="amount" id="withdrawValue" placeholder="Sem pontos, virgulas ou centavos" class="large-input-field w-node-_050dfc36-93a8-d840-d215-4fca9adfe60d-9adfe605 w-input">
                </div>
            </div>
            <div class="">
